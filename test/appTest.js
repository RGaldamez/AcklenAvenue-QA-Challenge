...
describe("Selenium automated functional tests", function () {
  ...
  describe("General tampering tests", async () => {
    ...
    it("Reserving a parking spot for 0 hours, no cost should appear or cost should be $0", async () => {
      await driver.findElement(By.name("ParkingLot")).sendKeys("Valet Parking");
      entryDate = await driver.findElement(By.name("StartingDate"));
      entryDate.clear();
      ...
      if (result) {
        ...
        assert.isUndefined(
          result,
          "A cost should not be displayed unless it is $0"
        );
      }
    });
    it("Testing AM and PM radio buttons", async () => {
      ...
      await driver
        .findElement(By.xpath('//input[@name="StartingTimeAMPM"][@value="AM"]'))
        .click();
      await driver.sleep(INPUT_TIME);
      await driver
        .findElement(By.xpath('//input[@name="LeavingTimeAMPM"][@value="PM"]'))
        .click();
      await driver.sleep(INPUT_TIME);
    ...
    it("Setting entry time after leaving time", async () => {
      ...
      await driver
        .findElement(By.xpath('//input[@name="StartingTimeAMPM"][@value="PM"]'))
        .click();
      await driver.sleep(INPUT_TIME);
      await driver
        .findElement(By.xpath('//input[@name="LeavingTimeAMPM"][@value="AM"]'))
        .click();
      await driver.sleep(INPUT_TIME);
  ...
  describe("Short-Term Parking tests", async () => {
    it("Selecting 1 hour of Short-Term Parking, cost should be $2", async () => {
      await driver
        .findElement(By.name("ParkingLot"))
        .sendKeys("Short-Term Parking");
      entryDate = await driver.findElement(By.name("StartingDate"));
      entryDate.clear();
      entryDate.sendKeys("10/23/2020");
      await driver.sleep(INPUT_TIME);
  ...
  describe("Long-Term Garage Parking tests", async () => {
    it("Long-Term Garage Parking for 6 hours and 59 minutes, cost should be $12 or under ", async () => {
      await driver
        .findElement(By.name("ParkingLot"))
        .sendKeys("Long-Term Garage Parking");
      entryDate = await driver.findElement(By.name("StartingDate"));
      entryDate.clear();
      entryDate.sendKeys("10/22/2020");
      await driver.sleep(INPUT_TIME);
  ...
  describe("Long-Term Surface Parking tests", async () => {
    it("Long-Term Surface Parking for 5 hours and 59 minutes, cost should be $10 or under ", async () => {
      await driver
        .findElement(By.name("ParkingLot"))
        .sendKeys("Long-Term Surface Parking");
      entryDate = await driver.findElement(By.name("StartingDate"));
      entryDate.clear();
      entryDate.sendKeys("10/22/2020");
      await driver.sleep(INPUT_TIME);
